...
.seat2{/* 통로 왼쪽 좌석 */
height: 30px; width: 30px; display: inline; padding: 10px,auto; background-color: lightgray; margin-right: 10%;
}
.seat1_on{/* 선택 좌석 */
...
<button type="button" class="seat1" title="A1" id="A1" value="A1">1</button>
<button type="button" class="seat1 seat2" title="A2" id="A2" value="A2">2</button>
<button type="button" class="seat1" title="A3" id="A3" value="A3">3</button>
<button type="button" class="seat1" title="A4" id="A4" value="A4">4</button>
<button type="button" class="seat1" title="A5" id="A5" value="A5">5</button>
...
<button type="button" class="seat1" title="A13" id="A13" value="A13">13</button>
<button type="button" class="seat1" title="A14" id="A14" value="A14">14</button>
</div>
<div class="B">
<button type="button" class="seat0" title="B" id="B" value="B" disabled="disabled">B</button>
<button type="button" class="seat1" title="B1" id="B1" value="B1">1</button>
<button type="button" class="seat1 seat2" title="B2" id="B2" value="B2">2</button>
<button type="button" class="seat1" title="B3" id="B3" value="B3">3</button>
<button type="button" class="seat1" title="B4" id="B4" value="B4">4</button>
<button type="button" class="seat1" title="B5" id="B5" value="B5">5</button>
...
<button type="button" class="seat1" title="B13" id="B13" value="B13">13</button>
<button type="button" class="seat1" title="B14" id="B14" value="B14">14</button>
</div>
<div class="C">
...
<button type="button" class="seat1" title="C3" id="C3" value="C3">3</button>
<button type="button" class="seat1" title="C4" id="C4" value="C4">4</button>
<button type="button" class="seat1" title="C5" id="C5" value="C5">5</button>
...
<button type="button" class="seat1" title="D3" id="D3" value="D3">3</button>
<button type="button" class="seat1" title="D4" id="D4" value="D4">4</button>
<button type="button" class="seat1" title="D5" id="D5" value="D5">5</button>
...
<div class="H">
<button type="button" class="seat0" title="H" id="H" value="H" disabled="disabled">H</button>
<button type="button" class="seat1" title="H1" id="H1" value="H1">1</button>
<button type="button" class="seat1 seat2" title="H2" id="H2" value="H2">2</button>
<button type="button" class="seat1" title="H3" id="H3" value="H3">3</button>
<button type="button" class="seat1" title="H4" id="H4" value="H4">4</button>
<button type="button" class="seat1" title="H5" id="H5" value="H5">5</button>
<button type="button" class="seat1" title="H6" id="H6" value="H6">6</button>
<button type="button" class="seat1" title="H7" id="H7" value="H7">7</button>
<button type="button" class="seat1" title="H8" id="H8" value="H8">8</button>
<button type="button" class="seat1" title="H9" id="H9" value="H9">9</button>
<button type="button" class="seat1" title="H10" id="H10" value="H10">10</button>
<button type="button" class="seat1" title="H11" id="H11" value="H11">11</button>
<button type="button" class="seat1 seat2" title="H12" id="H12" value="H12">12</button>
<button type="button" class="seat1" title="H13" id="H13" value="H13">13</button>
<button type="button" class="seat1" title="H14" id="H14" value="H14">14</button>
</div>
<div class="I">
<button type="button" class="seat0" title="I" id="I" value="I" disabled="disabled">I</button>
<button type="button" class="seat1" title="I1" id="I1" value="I1">1</button>
<button type="button" class="seat1 seat2" title="I2" id="I2" value="I2">2</button>
...
<button type="button" class="seat1" title="J1" id="J1" value="J1">1</button>
<button type="button" class="seat1 seat2" title="J2" id="J2" value="J2">2</button>
...
<button type="button" class="seat1" title="K1" id="K1" value="K1">1</button>
<button type="button" class="seat1 seat2" title="K2" id="K2" value="K2">2</button>
...
<button type="button" class="seat1" title="L1" id="L1" value="L1">1</button>
<button type="button" class="seat1 seat2" title="L2" id="L2" value="L2">2</button>
...
<button type="button" class="seat1" title="M1" id="M1" value="M1">1</button>
<button type="button" class="seat1 seat2" title="M2" id="M2" value="M2">2</button>
...
<button type="button" class="seat1" title="N1" id="N1" value="N1">1</button>
<button type="button" class="seat1 seat2" title="N2" id="N2" value="N2">2</button>
